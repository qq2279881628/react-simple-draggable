...
/***/ "./node_modules/css-loader/index.js?modules!./node_modules/less-loader/dist/cjs.js?!./src/Draggable.less":
/*!***************************************************************************************************************!*\
  !*** ./node_modules/css-loader?modules!./node_modules/less-loader/dist/cjs.js??ref--7-2!./src/Draggable.less ***!
  \***************************************************************************************************************/
...
var _Draggable = __webpack_require__(/*! ./Draggable.less */ "./src/Draggable.less");
...
var Draggable = function (_React$Component) {
    ...
    function Draggable(props) {
        ...
        _this.state = {
            start: false,
            movedPosition: props.initPosition ? props.initPosition : {
                x: 0,
                y: 0
            },
            controled: {
    ...
    (0, _createClass3.default)(Draggable, [{
        key: "moving",
        value: function moving(movedPosition, targetPosition) {
            var _state$controled = this.state.controled,
                left = _state$controled.left,
                top = _state$controled.top,
                right = _state$controled.right,
                bottom = _state$controled.bottom;
            ...
            var movedX = _event.clientX - targetPosition.x;
            var movedY = _event.clientY - targetPosition.y;
            var x = void 0,
                y = void 0;
            //该移动的距离
            var movingX = movedPosition.x + movedX;
            var movingY = movedPosition.y + movedY;
            //元素的宽度
        ...
        key: "stop",
        value: function stop(middleMoving, middleStop) {
            this.setState({
                start: false
            });
        ...
        value: function handleMouseDown() {
            ...
            var controled = this.props.controled;
            ...
            this.setState({
                start: true,
                controled: (0, _extends3.default)({}, controled)
            });
            var movedPosition = this.state.movedPosition;

            var middleMoving = function middleMoving() {
                return _this2.moving(movedPosition, targetPosition);
            };
            var middleStop = function middleStop() {
                return _this2.stop(middleMoving, middleStop);
            };
        ...
        value: function componentDidMount() {
            ...
            main.addEventListener("mousedown", this.handleMouseDown.bind(this), false);
        }
    }, {
        ...
        value: function render() {
            ...
            var CloneEle = _react2.default.Children.map(this.props.children, function (child) {
                return _react2.default.cloneElement(child, { movedposition: movedPosition });
            });
            return _react2.default.createElement(
                "div",
                { className: _Draggable2.default.main, style: style, ref: "main" },
                CloneEle
            );
        }
    }]);
...
var content = __webpack_require__(/*! !../node_modules/css-loader?modules!../node_modules/less-loader/dist/cjs.js??ref--7-2!./Draggable.less */ "./node_modules/css-loader/index.js?modules!./node_modules/less-loader/dist/cjs.js?!./src/Draggable.less");
...
var _Draggable = __webpack_require__(/*! ./Draggable.js */ "./src/Draggable.js");
